...
file = PdfFileReader("E:/UAS_PSKD_TID_V3921008_DEVY IKA Y/enskripsideskripsiPDF/enkripsiPDF.pdf")
...
if file.isEncrypted:
    ...
    with open("E:/UAS_PSKD_TID_V3921008_DEVY IKA Y/enskripsideskripsiPDF/deskripsiPDF.pdf", "wb") as f:
